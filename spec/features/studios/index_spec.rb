...
RSpec.describe 'studios index page' do
  before :each do
    ...
    @movie_1 = Movie.create!(title: "title1", creation_year: 2008, genre: "Action", @studio_1.id)
    @movie_2 = Movie.create!(title: "title2", creation_year: 2018, genre: "Action", @studio_1.id)
    @movie_3 = Movie.create!(title: "title3", creation_year: 2014, genre: "Romance", @studio_2.id)
    @movie_4 = Movie.create!(title: "title4", creation_year: 2012, genre: "Action", @studio_2.id)
  end
